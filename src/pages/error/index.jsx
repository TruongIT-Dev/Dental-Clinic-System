...
<main>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>404</h1>
        <h2>CÓ VẺ ĐÃ XẢY RA LỖI.</h2>
        <p>Trang bạn đang tìm không có.
          Có vẻ trang bạn tìm đang xảy ra trục trặc hoặc không có hoặc đã bị xóa, quay lại trang chủ và thử lại nhé.
        </p>
        <button href='/' class="btn green">Trang Chủ</button>
      </div>
    </div>
  </div>
</main>
