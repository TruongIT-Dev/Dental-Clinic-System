      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-6 align-self-center">
            ...
            <h2>Xin lỗi! Bạn cần đăng nhập để tiếp tục.</h2>
            <p>Trang bạn đang tìm kiếm yêu cầu đăng nhập để truy cập, vui lòng đăng nhập để tiếp tục sử dụng.
            </p>
            <button className="btn btn-outline-primary">Đăng nhập</button>
            <p>Nếu chưa có tài khoản, bạn vui lòng đăng ký tài khoản.
            </p>
