        ...
        >
            <Sider collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)} breakpoint="xxl">
                ...
                <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}
                    ...
                    <Menu.SubMenu key="sub1" title="Quản lý Nha sĩ" icon={<TeamOutlined />}>
                        <Menu.Item key="6">
                    ...
                    <Menu.SubMenu key="sub3" title="Quản lý Dịch vụ" icon={<TeamOutlined />}>
                        <Menu.Item key="8">
                            <Link style={{ textDecoration: 'none' }} to="/quan-ly-dich-vu">Danh sách Dịch vụ</Link>
                        </Menu.Item>
                        <Menu.Item key="9">
